    ...
    try {
      ...
      if (data.token) {
        ...
        const userToSave = data.user || {
          name: name || (email.toLowerCase().includes("ajinkya") ? "Ajinkya Biradar" : email.split("@")[0]),
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16">
        <div className="w-full max-w-md flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#FF5A1F]/10 border border-[#FF5A1F]/20 text-xs font-mono text-[#FF5A1F] font-bold w-fit">
            ...
            <p className="text-sm text-[#15170F]/70 font-normal">
              Connect your fleet in 2 minutes — zero credit card required.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <User className="w-4 h-4 text-[#15170F]/40 absolute left-3.5 top-1/2 -translate-y-1/2" />
                  <input
                    type="text"
                    required
                    value={name}
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-full bg-white border border-[#15170F]/15 text-sm font-sans text-[#15170F] focus:outline-none focus:ring-2 focus:ring-[#FF5A1F]/50"
                  />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <Building className="w-4 h-4 text-[#15170F]/40 absolute left-3.5 top-1/2 -translate-y-1/2" />
                  <input
                    type="text"
                    required
                    value={company}
                    onChange={(e) => setCompany(e.target.value)}
                    placeholder="Aether Logistics"
                    className="w-full pl-10 pr-4 py-2.5 rounded-full bg-white border border-[#15170F]/15 text-sm font-sans text-[#15170F] focus:outline-none focus:ring-2 focus:ring-[#FF5A1F]/50"
                  />
                </div>
              </div>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="alex@aetherfreight.com"
                  className="w-full pl-10 pr-4 py-2.5 rounded-full bg-white border border-[#15170F]/15 text-sm font-sans text-[#15170F] focus:outline-none focus:ring-2 focus:ring-[#FF5A1F]/50"
                />
              </div>
            </div>
          ...
          <div className="text-center text-xs font-sans text-[#15170F]/70">
            ...
            <a href="/login" className="text-[#FF5A1F] font-bold hover:underline">
              Sign in
            </a>
          </div>
